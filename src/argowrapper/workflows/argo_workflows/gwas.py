...
class GWAS(WorkflowBase):
    ...
    Attributes:
        ...
        workflow_parameters (Dict): a dictionary of request parameters from the user, with **complex parameters flattened as a string** - TODO: add validation to enforce this last part?
    """
